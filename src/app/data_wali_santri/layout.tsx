...
export default function DataWaliSantriLayout({
  children,
}: {
  children: ReactNode;
}) {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      toast({
        ...
        description: 'Anda telah berhasil masuk ke data potensi walisantri.',
        status: 'success',
        duration: 3000,
        isClosable: true,
      });
              ...
              <VStack spacing={6} align="center">
                ...
                <VStack spacing={2} textAlign="center">
                  ...
                  <Text color={mutedTextColor} fontSize="sm">
                    ...
                    data potensi walisantri POSKU Al-Fatih Bogor.
                  </Text>
                </VStack>
                ...
                <Text fontSize="xs" color="gray.500" textAlign="center">
                  Data ini bersifat internal, hanya untuk panitia dan pengurus
                  yang membutuhkan.
                </Text>
              </VStack>
            </CardBody>
  ...
  // Hanya pengurus POSKU yang boleh mengakses data wali santri
  if (!user.pengurus) {
    return (
      <Container maxW="md" py={12}>
        <Stack spacing={8} align="center">
  ...
  return (
    <Box maxW="6xl" mx="auto" px={{ base: 4, sm: 6 }} py={4}>
      <Flex
